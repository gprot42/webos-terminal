...
// optional-chaining (?.) and nullish-coalescing (??) syntax, which predates
// Chrome 80. Older/entry-level webOS TVs (e.g. UP7550PTC on webOS 6.5.3) run
// a Chromium build that cannot parse that syntax at all, so the whole bundled
// dist/main.js fails to parse and the app window stays completely black.
//
...
console.log('downlevel-syntax: transformed optional chaining / nullish coalescing in dist/main.js');
